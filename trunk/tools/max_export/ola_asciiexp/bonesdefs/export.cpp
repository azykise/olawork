...
void AsciiExp::ExportMesh(INode* node, TimeValue t, int indentLevel)
{
	...
	if ( GetIncludeSkin() && bone_mod )
	{
		...
		//{
		//	int vert_bones = bone_mod->GetNumAssignedBones(i);
...
void AsciiExp::GetVertexBoneInfo(VertexBoneInfo* out,int skined_vid,BoneModData* bone_mod)
{	
	int num = bone_mod->GetNumPoints();
}
