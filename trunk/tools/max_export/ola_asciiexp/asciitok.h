...
#define ID_MESH_TANGENTS		_T("*MESH_TANGENTS")
...
#define ID_MESH_VERTEXBONES		_T("*MESH_VERTEXBONES")
#define ID_MESH_VERTEXBONE		_T("*MESH_VERTEXBONE")
#define ID_MESH_VERTEXBONE_NUM	_T("*MESH_VERTEXBONE_NUM")
#define ID_MESH_SKELETON		_T("*MESH_SKELETON")
...
#define ID_SKELETON_BONE_NUM	_T("*SKELETON_BONE_NUM")
#define ID_SKELETON_BONE		_T("*SKELETON_BONE")
...
#define ID_MESH_FACETANGENT     _T("*MESH_FACETANGENT")
#define ID_MESH_VERTEXTANGENT   _T("*MESH_VERTEXTANGENT")
#define ID_MESH_VERTEXBNORMAL	_T("*MESH_VERTEXBNORMAL")
