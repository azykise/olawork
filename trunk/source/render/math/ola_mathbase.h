...
#define DEG2RAD(a)				( (a) * olaMath::M_DEG2RAD )
#define RAD2DEG(a)				( (a) * olaMath::M_RAD2DEG )

#define SEC2MS(t)				( olaMath::FtoiFast( (t) * olaMath::M_SEC2MS ) )
#define MS2SEC(t)				( (t) * olaMath::M_MS2SEC )

#define	ANGLE2SHORT(x)			( olaMath::FtoiFast( (x) * 65536.0f / 360.0f ) & 65535 )
#define	SHORT2ANGLE(x)			( (x) * ( 360.0f / 65536.0f ) )

#define	ANGLE2BYTE(x)			( olaMath::FtoiFast( (x) * 256.0f / 360.0f ) & 255 )
...
public:
	...
	static bool					IsZero(float f) {return ((*(const unsigned long *)&(f)) & ~(1<<31)) == 0;}
