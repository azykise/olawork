...
namespace editor
{
    ...
    //{
    //    protected void setBasePrimitive( Primitive pri)
    //    {
    //        mPrimitive = pri;
    //    }
    //    public override bool pushToSelect(uint id,  RenderSystem rendersys)
    //    {
    //        if(mPrimitive != null)
    ...
    //    public override void render( RenderSystem rendersys)
    //    {
    //        if(mPrimitive != null)
    //            mPrimitive.render(rendersys);
    //    }
       
    //    private  Primitive mPrimitive = null; //基类专用 子类可以保留具体类型的primitive
    //}
    ...
    //    public SceneBorderCube(string name, RenderSystem rendersys)
    //    {
    //        mName = name;
    ...
    //     PrimitiveBorderCube mCube = null;
    //}
    ...
    //    public ScenePlane(string name,  RenderSystem rendersys)
    //    {
    //        mName = name;
    ...
    //    public void initialize(string config_path, RenderSystem rendersys)
    //    {
    //        mRendersys = rendersys;
    //    }

    //    public Entity createEntity(string type, Dictionary<string, object> propertys,  RenderSystem rendersys)
    //    {
